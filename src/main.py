...
def infer(model: Model,fn_img: Path) -> None:
    ...
    print(f'Accuracy: {probability[0]*100.0}%')
    plt.text(0.5,0.67,"Accuracy = {}".format(probability[0]))
    #plt.show()
...
if __name__ == '__main__':
    ...
    fn_img2=cv2.imread('..\data\hello.png')
    plt.figure(figsize=(3,3))
    #ims = cv2.resize(fn_img2, (960, 540))
    #plt.subplot(2,2,1)
    plt.imshow(fn_img2)
    plt.title('Original')
    plt.axis('off')
